...
export default function TicketDetailView({ ticket: initialTicket, onTicketUpdate }) {
    ...
    // Check if file upload is restricted for this ticket (Facility Management)
    const isUploadRestricted = (ticket.departmentId?.name || ticket.department?.name) === 'Facility Management';
